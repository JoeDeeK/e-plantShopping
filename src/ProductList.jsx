...
function ProductList() {
   ...
   const styleA={
    ...
    const handleAddToCart = (product) => {
        ...
        isAdded ? dispatch(removeItem(product)) : dispatch(addItem(product));
    ...
    useEffect(() => {}, [showCart, showPlants, addedToCart]);
    ...
    return (
            ...
            <div className="tag">
               <div className="luxury">
                ...
                <a href="/" style={{textDecoration:'none'}}>
                    <div>
                        <h3 style={{color:'white'}}>Paradise Plant Nursery</h3>
                        <i style={{color:'white'}}>Where Green Meets Serenity and Beauty</i>
                    </div>
                    </a>
                </div>
            </div>
                    ...
                    <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                                ...
                                <text x="100" y="150" font-family="Verdana" font-size="70" fill="white">{calculateTotalItems()}</text>
        ...
        {plantsArray.map((category, categoryIndex) => (
            ...
            <h2 className="category-title"><div>{category.category}</div></h2>
